...
protected:
    bool OnMainTcpSocketCenter( MsgHead *pMsgHead, void *pData, unsigned int wDataSize );
    bool OnMainTcpSocketHall( MsgHead *pMsgHead, void *pData, unsigned int wDataSize );
